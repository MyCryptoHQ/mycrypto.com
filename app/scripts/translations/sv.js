...
GEN_Help_12                 : 'Använd filen för att låsa upp din plånbok via t.ex MyCrypto, Mist, Geth, Parity eller andra klienter.',
...
sidebar_donation            : 'MyCrypto är en gratis service, med öppen källkod inriktade på din integritet och säkerhet. Ju fler donationer vi får, desto mer tid lägger vi på att skapa nya funktioner, lyssna på feedback, och ge dig vad du vill. Vi är bara två personer som försöker förändra världen. Hjälp oss? ',
...
MYWAL_Content_3             : 'Om du vill använda plånboken med MyCrypto CX i framtiden, måste du manuellt lägga till den med hjälp av den privata nyckeln / JSON filen och lösenordet. ',
