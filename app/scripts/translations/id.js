...
X_HelpfulLinks_4                :  'Migrasi ke/dari MyCrypto',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Selamat datang di MyCrypto.com',
...
ONBOARD_welcome_content__4      :  'Apa itu MyCrypto? ',
ONBOARD_welcome_content__5      :  'MyCrypto adalah antarmuka sisi klien berbasis open source yang gratis.',
ONBOARD_welcome_content__6      :  'MyCrypto memungkinkan Anda untuk berinteraksi langsung dengan blockchain sambil tetap memegang kendali penuh atas kunci &amp; dana Anda.',
...
ONBOARD_bank_title              :  'MyCrypto bukan Bank',
...
ONBOARD_interface_title         :  'MyCrypto adalah sebuah antarmuka',
ONBOARD_interface_content__1    :  'Saat membuat akun di MyCrypto, Anda menghasilkan kumpulan nomor kriptografi: Kunci Privat dan kunci publik (alamat) Anda.',
...
ONBOARD_bank_title__alt         :  'MyCrypto bukan sebuah Bank',
...
ONBOARD_blockchain_content__4   :  'Blok di blockchain berisi catatan dari semua transaksi individual yang dikirim dari MyCrypto, MetaMask, Exodus, Mist, Geth, Parity, dan lain-lainnya..',
ONBOARD_blockchain_content__5   :  'Saat Anda melihat saldo di MyCrypto.com atau melihat transaksi Anda di [etherscan.io](https://etherscan.io), Anda melihat data di blockchain, bukan di sistem privat Anda.',
ONBOARD_blockchain_content__6   :  'Sekali lagi: **kami bukan sebuah bank**.',
ONBOARD_interface_title__alt    :  'MyCrypto adalah sebuah antarmuka',
...
ONBOARD_blockchain_title__alt   :  'Apa itu Blockchain?',
ONBOARD_point_title__alt        :  'Jadi apa gunanya MyCrypto kalau begitu?',
ONBOARD_whymyc_title            :  'Jika MyCrypto tidak dapat melakukan semua hal tersebut, lalu apa gunanya?',
ONBOARD_whymyc_content__1       :  'Karena itulah esensi desentralisasi dan blockchain.',
ONBOARD_whymyc_content__2       :  'Anda tidak harus bergantung pada bank, pemerintah, atau orang lain saat Anda ingin memindahkan dana Anda.',
ONBOARD_whymyc_content__3       :  'Anda tidak harus bergantung pada keamanan bursa atau bank agar dana Anda tetap aman.',
ONBOARD_whymyc_content__4       :  'Jika Anda tidak menganggap hal-hal ini berharga, tanyakan pada diri Anda mengapa Anda menganggap blockchain dan cryptocurrencies sangat berharga. 😉',
ONBOARD_whymyc_content__5       :  'Jika Anda tidak berkenan, Anda bisa menggunakan [Coinbase](https://www.coinbase.com/) atau [Blockchain.info](https://blockchain.info/wallet/#/signup). Mereka memiliki akun yang lebih mirip dengan yang biasa Anda temui yaitu menggunakan username & password.',
ONBOARD_whymyc_content__6       :  'Jika Anda takut tapi ingin menggunakan MyCrypto, [gunakan dompet hardware](https://support.mycrypto.com/hardware-wallets/hardware-wallet-recommendations.html)! Perangkat ini akan menjaga kunci Anda tetap aman.',
...
ONBOARD_secure_1_content__1     :  'Phisher biasanya mengirim Anda pesan dengan link ke situs web yang sekilas terlihat seperti MyCrypto, EtherDelta, Paypal, atau bank Anda, namun bukan situs web yang asli. Mereka mencuri informasi Anda dan kemudian mencuri uang Anda.',
ONBOARD_secure_1_content__2     :  'Pasang [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) atau [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) atau [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) untuk memblokir situs web jahat.',
ONBOARD_secure_1_content__3     :  'Selalu periksa URLnya: `https://mycrypto.com`.',
ONBOARD_secure_1_content__4     :  'Pastikan bar URL menunjukkan `MyCrypto, Inc.` dalam warna hijau.',
...
ONBOARD_secure_3_content__6     :  '[Lihat lebih banyak lagi tentang Tips Keamanan!](https://support.mycrypto.com/getting-started/protecting-yourself-and-your-funds.html)',
...
ONBOARD_final_content__3        :  'Cara Setup MyCrypto + MetaMask',
ONBOARD_final_content__4        :  'Cara Menjalankan MyCrypto Offline / Lokal',
...
tx_notFound_2               : 'Jika transaksi baru saja terkirim, tunggu 15 detik dan tekan tombol "TX Status" lagi. ',
tx_notFound_3               : 'Kemungkinan masih di TX pool dari node lain, menunggu untuk ditambang (mined).',
tx_notFound_4               : 'Gunakan dropdown di kanan atas & pilih node ETH lainnya (e.g. `ETH (Etherscan.io)` atau `ETH (Infura.io)` atau `ETH (MyCrypto)`) dan check kembali.',
...
GEN_Help_12                 : 'Pakailah untuk membuka dompet Anda melalui MyCrypto (atau Mist, Geth, Parity maupun perangkat lunak dompet lainnya.) ',
...
TXFEE_Desc                  : 'Biaya TX Fee dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Jumlahnya =  `gas limit` * `gas price`. [Anda dapat mengkonversi GWEI -> ETH](https://mycrypto.com/helpers.html)',
...
/* Header */
MYC_Warning_1               : 'Pastikan menggunakan URL yang benar sebelum mengakses Dompet Anda atau sebelum membuat dompet baru. Waspadai situs phishing! ',
...
ADD_Ledger_0a               : 'Buka kembali MyCrypto melalui koneksi (SSL) yang aman ',
ADD_Ledger_0b               : 'Buka kembali MyCrypto menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Jika Anda akan memakai dompet ini dengan MyCrypto CX Anda ke depan, Kunci Privat/JSON dan password harus ditambahkan lagi secara manual. ',
...
NODE_Warning                : 'Node Anda harus berupa HTTPS untuk dapat terhubung melalui MyCrypto.com. Anda dapat [mengunduh MyCrypto repo & menjalankannya secara lokal](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest) untuk terhubung ke node apa saja. Atau, dapatkan SSL certificate gratis melalui [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Nama Node',
NODE_Port                   : 'Port Node',
...
ERROR_28                    : '**DIPERLUKAN File Keystore & password** (atau Kunci Privat) untuk mengakses dompet Anda. Simpan dan backup dengan baik file ini! Tidak ada mekanisme untuk me-recover dompet jika file-nya hilang. Baca instruksi lengkapnya [di sini](https://mycrypto.com/#help). ',
...
ERROR_35                    : 'Address yang dimasukkan tidak di checksum. <a href="https://support.mycrypto.com/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> Informasi lebih lanjut</a>', // 35
...
PARITY_InvalidGasLimit      : "(parity-05) Gas yang disediakan nilainya diatas limit. Supplied gas limit is beyond limit. Try lowering the gas limit to 21000. [Learn More.](https://support.mycrypto.com/gas/what-is-gas-ethereum.html)",
...
TranslatorName_1            : '[Yos Ginting](https://mycrypto.com/?gaslimit=21000&to=0x8F646C5c215be6E0163f02Bd2eB97AFC2DF70e5c&value=1.0#send-transaction) ',
...
HELP_Desc                   : 'Anda melihat sesuatu yang hilang? Atau ada pertanyaan lain? [Hubungi kami](mailto:support@mycrypto.com), dan kami tidak hanya akan menjawab pertanyaan Anda, kami akan memperbarui halaman ini untuk lebih bermanfaat bagi pengguna lainnya kedepan! ',
HELP_Remind_Title           : 'Beberapa pengingat ',
HELP_Remind_Desc_1          : '** Ethereum, MyCrypto.com, dan beberapa library Javascript yang kami gunakan sedang dalam pengembangan yang aktif.** Meskipun kami telah benar-benar menguji & puluhan ribu dompet telah berhasil diciptakan oleh para pengguna di seluruh dunia, selalu ada kemungkinan bahwa sesuatu yang tidak terduga dapat terjadi yang menyebabkan ETH Anda hilang. Tolong jangan menginvestasikan lebih dari yang Anda mampu kehilangan, dan mohon berhati-hati. Jika ada sesuatu yang buruk terjadi, kami mohon maaf, tapi **kami tidak bertanggung jawab atas Ether yang hilang**. ',
HELP_Remind_Desc_2          : 'MyCrypto.com bukan "dompet web". Anda tidak membuat akun atau memberikan Ether Anda untuk kami pegang. Semua data tidak pernah meninggalkan komputer/browser Anda. Kami mempermudah Anda untuk membuat, menyimpan, dan mengakses informasi Anda dan berinteraksi dengan blockchain. ',
...
HELP_2b_Title               : '2b) Bagaimana cara penyimpanan yang aman / offline / cold storage menggunakan MyCrypto? ',
HELP_2b_Desc_1              : 'Kunjungi [https://github.com/MyCryptoHQ/mycrypto.com/releases/latest](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest). ',
...
HELP_3_Desc_3               : 'Buka laman MyCrypto.com bagian "Lihat Info Dompet" . ',
...
HELP_4CX_Title              : '4) Bagaimana cara mengirim Ether menggunakan MyCrypto CX? ',
...
HELP_5_Title                : '5) Bagaimana cara menjalankan MyCrypto.com secara offline/lokal? ',
HELP_5_Desc_1               : 'Anda dapat menjalankan MyCrypto.com secara lokal di komputer Anda, bukan dari server GitHub. Anda dapat membuat dompet yang benar-benar offline dan mengirim transaksi dari laman "Transaksi Offline". ',
HELP_5_Desc_7               : 'MyCrypto.com sekarang berjalan sepenuhnya di komputer Anda. ',
HELP_5_Desc_8               : 'Jika Anda belum pernah melakukannya, Anda harus menyimpan folder dan seluruh isinya (bukan hanya `index.html`) agar bisa menjalankan websitenya. Jangan rubah atau pindahkan file apapun yang ada di dalam folder. Jika Anda akan menyimpan backup dari MyCrypto repo, sebaiknya simpan versi ZIP-nya untuk menggaransi bahwa isi foldernya lengkap. ',
HELP_5_Desc_9               : 'Karena kami masih terus memperbarui MyCrypto.com, sebaiknya Anda juga memperbarui versi repo yang Anda simpan secara berkala. ',
...
HELP_8_Desc_1               : 'MyCrypto bukan dompet web. Anda tidak memiliki login dan tidak ada yang bisa disimpan ke server kami. Ini hanyalah sebuah antarmuka yang memungkinkan Anda berinteraksi dengan blockchain. ',
HELP_8_Desc_2               : 'Jika situs MyCrypto.com tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Ethereum Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" Ether Anda dari MyCrypto.com karena Ether Anda tidak disimpan di MyCrypto.com. Ether Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
...
HELP_8_Desc_4               : 'Lebih dari itu, kemungkinan kita menghentikan layanan MyCrypto sangat kecil. Hampir tidak ada biaya dari penyelenggaraan layanan ini karena kami tidak menyimpan data apapun. Kalaupun sampai kami menghentikan layanan, semua file ini akan selalu akan tersedia untuk umum di [https://github.com/MyCryptoHQ/mycrypto.com](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages). Anda bisa mendownload file ZIP-nya disana dan menjalankannya secara lokal. ',

HELP_8CX_Title              : '8) Apa yang terjadi jika MyCrypto CX tidak beredar lagi? ',
...
HELP_8CX_Desc_2             : 'terlepas dari semua itu, **sangat penting** bagi Anda untuk membuat backup/cadangan dari semua informasi dompet baru yang Anda buat dengan MyCrypto CX. Dengan begitu, jika terjadi sesuatu pada MyCrypto CX atau komputer Anda, Anda masih memiliki semua informasi yang diperlukan untuk mengakses Ether Anda. Lihat #2a untuk cara membuat backup/cadangan dompet Anda. ',
HELP_8CX_Desc_3             : 'Jika karena suatu hal maupun lainnya MyCrypto CX tidak lagi tersedia di Chrome Store, Anda tetap dapat menemukan file aslinya di Github dan menjalankannya secara manual. Lihat #5 di atas. ',
...
HELP_12_Title               : '12) Bagaimana cara mengimpor dompet yang dibuat dengan MyCrypto ke dalam geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Memakai file Geth/Mist JSON yang dibuat dari MyCrypto v2+.... ',
HELP_12_Desc_2              : 'Buka halaman "Lihat Info Dompet/View Info". ',
...
HELP_16_Desc_1              : 'Anda bisa menggunakan eksplorer blockchain seperti [etherscan.io](https://etherscan.io/). Paste alamat Anda ke dalam search bar dan riwayat transaksi Anda akan ditampilkan. Contohnya, [akun donasi kami](https://etherscan.io/address/0x4bbeEB066eD09B7AEd07bF39EEe0460DFa261520) dilihat di etherscan.io ',
...
HELP_SecCX_Title            : 'Keamanan - MyCrypto CX ',
...
HELP_SecCX_Desc_6           : 'Jika kami mengenkripsi item ini, Anda harus memasukkan password setiap kali Anda ingin melihat saldo akun atau melihat nickname. Jiak Anda khawatir, kami sarankan Anda menggunakan MyCrypto.com, bukan Chrome Extension ini. ',
...
HELP_Sec_Desc_2             : 'Kami sudah ada sejak 2015. Jika Anda mencari ["mycrypto" di reddit](https://www.reddit.com/search?q=mycrypto), Anda bisa melihat banyak orang yang sudah menggunakan layanan kami dan baik-baik saja. ',
...
HELP_Sec_Desc_4             : 'Periksa URL ini -- Situs ini dijalankan melalui GitHub dan Anda bisa melihat sorce code nya di sini: [https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages) ke [https://mycrypto.com](https://mycrypto.com). ',
HELP_Sec_Desc_5             : 'Untuk membuat dompet, Anda dapat mendownload [source code dan menjalankannya secara lokal](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest). Lihat #5 di atas. ',
