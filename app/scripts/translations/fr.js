...
tx_notFound_4               : 'Veuillez utiliser le menu déroulant en haut à droite & sélectionner un nœud ETH différent (par ex. `ETH (Etherscan.io)`, `ETH (Infura.io)` ou `ETH (MyCrypto)`) puis revérifiez.',
...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec MyCrypto (ou Mist, Geth, Parity et autres clients.) ',
...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `GAS limite` * le `prix du GAS`. [Vous pouvez convertir GWEI -> ETH ici.](https://mycrypto.com/helpers.html)',
...
/* Header */
MYC_Warning_1               : 'Vérifiez toujours l\'URL avant d\'accéder à votre portefeuille ou d\'en générer un nouveau. Attentions aux sites de phishing !',
...
MYC_Tagline                 : 'Portefeuille d\'Ether Open Source, écrit en JavaScript',
...
ADD_Ledger_0a               : 'Rouvrir MyCrypto sur une connexion sécurisée (SSL)',
ADD_Ledger_0b               : 'Rouvrir MyCrypto avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
ADD_DigitalBitbox_0a        : 'Rouvrir MyCrypto sur une connexion sécurisée (SSL)',
ADD_DigitalBitbox_0b        : 'Rouvrir MyCrypto avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
NODE_Warning                : 'Votre nœud doit être en HTTPS pour vous y connecter via MyCrypto.com. Vous pouvez [télécharger MyCrypto et le lancer localement](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest) pour vous connecter à un nœud quelconque, ou obtenir un certificat SSL gratuit via [LetsEncrypt](https://letsencrypt.org/)',
...
ERROR_35                    : '(error_36) Input address is not checksummed. <a href="https://support.mycrypto.com/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer">What does that mean?</a> L\'adresse d\'entrée n\'a pas de somme de contrôle. <a href="https://support.mycrypto.com/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener">Cliquez ici pour plus d\'infos</a>.',
...
GETH_Balance                : '(geth-01) Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more ETH to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://support.mycrypto.com/transactions/transactions-not-showing-or-pending.html). Solde insuffisant',
...
GETH_GasLimit               : '(geth-03) Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://support.mycrypto.com/gas/what-is-gas-ethereum.html). Limite de Gas dépassée',
GETH_InsufficientFunds      : '(geth-04) Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more ETH to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://support.mycrypto.com/transactions/transactions-not-showing-or-pending.html). Fonds insuffisants pour (Gas * prix) + valeur',
...
HELP_Desc                   : 'Il manque quelque chose ? Vous avez d\'autres questions ? [Contactez-nous](mailto:support@mycrypto.com), et non seulement nous allons vous répondre, mais nous mettrons aussi à jour cette page afin qu\'elle soit plus utile à tout le monde à l\'avenir !',
HELP_Remind_Title           : 'Quelques rappels :',
HELP_Remind_Desc_1          : '**Ethereum, MyCrypto.com, ainsi que certaines des bibliothèques Javascript que nous employons sont en cours de développement.** Bien que nous les ayons testés intensivement et que des dizaines de milliers de portefeuilles aient été créés avec succès dans le monde entier, il existe toujours une faible possibilité qu\'un incident se produise, conduisant à la perte de vos ethers. N\'investissez pas plus que ce que vous pouvez vous permettre de perdre, et restez toujours prudents. En cas d\'accident, nous en serons désolés mais **nous ne sommes pas responsables d\'une éventuelle perte d\'ether**.',
HELP_Remind_Desc_2          : 'MyCrypto.com ne sont pas des "portefeuilles web". Vous ne créez pas un compte, vous ne déposez pas votre ether chez nous. Aucune donnée ne sort de votre ordinateur ou de votre navigateur. Nous vous facilitons la création, la sauvegarde et l\'accès à vos informations ainsi que l\'interaction avec le blockchain.',
...
HELP_2b_Title               : '2b) Comment puis-je gérer en toute sécurité un stockage hors ligne avec MyCrypto ?',
HELP_2b_Desc_1              : 'Allez sur notre référentiel Github : [https://github.com/MyCryptoHQ/mycrypto.com/releases/latest](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest).',
...
HELP_3_Desc_3               : 'Naviguez vers la page Visualisation d\'un portefeuille" de MyCrypto.com.',
...
HELP_4CX_Title              : '4) Comment puis-je envoyer de l\'Ether avec MyCrypto CX ?',
...
HELP_5_Title                : '5) Comment puis-je lancer MyCrypto.com hors ligne (en local) ?',
HELP_5_Desc_1               : 'Vous pouvez lancer MyCrypto.com sur votre ordinateur au lieu de passer par les serveurs GitHub. Vous pouvez générer un portefeuille en restant totalement hors ligne et envoyer des transactions depuis la page "Transaction hors ligne".',
HELP_5_Desc_7               : 'MyCrypto.com tourne maintenant complètement sur votre ordinateur.',
HELP_5_Desc_8               : 'Au cas où cela ne vous est pas familier, vous devez conserver l\'intégralité du dossier pour faire tourner le site web et non uniquement `index.html`. Ne touchez à rien, ne déplacez rien dans le dossier. Si vous stockez une sauvegarde du repo MyCrypto pour l\'avenir, nous vous recommandons de ne stocker que le ZIP afin d\'être sûr que le contenu du dossier restera intact.',
HELP_5_Desc_9               : 'Comme nous améliorons constamment MyCrypto.com, nous vous recommandons de mettre régulièrement à jour votre version de sauvegarde.',
...
HELP_8_Desc_1               : 'MyCrypto n\'est pas un portefeuille web. Vous n\'avez pas de compte dessus et rien n\'est jamais stocké sur nos serveurs. Ce n\'est qu\'une interface qui vous permet d\'interagir avec le blockchain.',
HELP_8_Desc_2               : 'Si MyCrypto.com venait à être hors ligne, vous devrez trouver un autre moyen (comme Geth ou Ethereum Wallet / Mist) pour faire la même chose. Mais vous n\'aurez pas à "récupérer" votre Ether depuis MyCrypto parce qu\'il ne se trouve pas dans MyCrypto. Il est chez vous, dans le portefeuille que vous avez généré par notre site.',
...
HELP_8_Desc_4               : 'De plus, la probabilité que nous laissions tomber MyCrypto approche zéro. Il ne nous coûte presque rien de le maintenir comme nous n\'y stockons aucune information. Si le domaine venait à être perdu, le logiciel sera toujours disponible publiquement sur [https://github.com/MyCryptoHQ/mycrypto.com](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages). Vous pourrez y télécharger le ZIP et le faire tourner localement.',

HELP_8CX_Title              : '8) Que se passe-t-il si MyCrypto CX disparaît ?',
...
HELP_8CX_Desc_2             : 'Cela dit, il est **très important** que vous sauvegardiez toutes les données de tous les portefeuilles générés par MyCrypto CX. De cette manière, si quoi que ce soit arrivait à MyCrypto CX ou à votre ordinateur, vous conserveriez toutes les informations nécessaires pour accéder à votre Ether. Voir #2a pour la sauvegarde de vos portefeuilles.',
HELP_8CX_Desc_3             : 'Si, pour une raison quelconque, MyCrypto CX disparaissait du Chrome Store, vous pourrez en trouver le source sur [https://github.com/MyCryptoHQ/mycrypto.com](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages) et le charger manuellement. Voir #5 ci-dessus.',
...
HELP_12_Title               : '12) Comment puis-je importer un portefeuille créé par MyCrypto dans geth, Ethereum Wallet ou Mist ?',
HELP_12_Desc_1              : 'Avec un fichier Geth/Mist JSON de MyCrypto v2+.... ',
...
HELP_SecCX_Title            : 'Sécurité - MyCrypto CX',
...
HELP_SecCX_Desc_6           : 'Si nous devions chiffrer ces informations, il vous faudrait entrer un mot de passe à chaque fois que vous voudriez voir votre solde ou les surnoms. Si cela vous ennuie, nous vous recommandons d\'utiliser MyCrypto.com au lieu de cette extension Chrome.',
...
HELP_Sec_Desc_2             : 'Nous avons commencé en août 2015. Si vous recherchez ["mycrypto" sur reddit](https://www.reddit.com/search?q=mycrypto), vous pouvez voir qu\'un nombre considérable de personnes nous utilisent sans problème. ',
...
HELP_Sec_Desc_4             : 'Vérifiez l\'URL -- Ce site est servi par Github (et vous pouvez en voir le code source ici : [https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages)) vers [https://mycrypto.com](https://mycrypto.com).',
HELP_Sec_Desc_5             : 'Pour générer les portefeuilles, vous pouvez télécharger le [code source](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest). Voir #5 ci-dessus. ',
