...
tx_notFound_4               : 'กรุณาใช้กล่อง dropdown ที่มุมขวาบน & เลือก ETH Node อื่น (เช่น `ETH (Etherscan.io)` หรือ `ETH (Infura.io)` หรือ `ETH (MyCrypto)`) และตรวจสอบอีกครั้ง',
...
GEN_Help_12                 : 'ใช้เพื่อปลดล็อกกระเป๋าของคุณผ่าน MyCrypto (หรือ Mist, Geth, Parity หรือโปรแกรมกระเป๋าอื่นๆ) ',
...
TXFEE_Desc                  : 'ค่าธรรมเนียมธุรกรรม (TX) จะถูกจ่ายให้กับผู้ขุดที่ขุด TX ของคุณลงในบล็อค มีค่าเท่ากับ `จำนวนจำกัดแก๊ส` * `ราคาแก๊ส` [คุณสามารถแปลง GWEI -> ETH ได้ที่นี่](https://mycrypto.com/helpers.html)',
...
MYC_Tagline                 : 'โอเพ่นซอร์ส JavaScript ฝั่งไคลเอนต์สำหรับสร้างกระเป๋า Ether ',
MYC_Warning_1               : 'ตรวจสอบ URL ทุกครั้ง ก่อนเข้าใช้กระเป๋าของคุณหรือสร้างกระเป๋าใหม่ ระวังเว็บไซต์ลอกเลียนแบบประสงค์ร้าย! ',

/* Footer */
FOOTER_1                    : 'ฟรี, โอเพ่นซอร์ส, อินเตอร์เฟสฝั่งไคลเอนต์สำหรับสร้างกระเป๋า Ethereum &amp; อื่นๆอีกมากมาย และทำธุรกรรมผ่านบล็อคเชนของ Ethereum ได้อย่างง่ายดาย &amp; ปลอดภัย อย่าลืมตรวจสอบ URL ( mycrypto.com ) ทุกครั้งก่อนเข้าใช้กระเป๋าของคุณ',
...
sidebar_donation            : 'MyCrypto ให้บริการฟรี, และเป็นโอเพ่นซอร์สเพื่อความเป็นส่วนตัว และความปลอดภัยของคุณ ยิ่งเราได้รับการบริจาคมากเท่าไหร่เราก็ยิ่งมีเวลาเพื่อสร้างฟีเจอร์ใหม่ๆ มากขึ้นเท่านั้น, พร้อมรับฟังข้อเสนอแนะ, และตอบสนองตามความต้องการของผู้ใช้ ซึ่งเราเป็นแค่ทีมสองคนที่อยากจะเปลี่ยนแปลงโลกใบนี้ สนใจช่วยเราไหม? ',
...
ADD_Ledger_0a               : 'คุณต้องเข้าใช้ MyCrypto ผ่านทางการเชื่อมต่อที่ปลอดภัย (SSL / HTTPS) ถึงจะสามารถเชื่อมต่อได้ ',
ADD_Ledger_0b               : 'เปิด MyCrypto อีกครั้งด้วย [Chrome](https://www.google.com/chrome/browser/desktop/) หรือ [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'เปิด MyCrypto อีกครั้งผ่านการเชื่อมต่อที่ปลอดภัย (SSL) ',
ADD_DigitalBitbox_0b        : 'เปิด MyCrypto อีกครั้งด้วย [Chrome](https://www.google.com/chrome/browser/desktop/) หรือ [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'ถ้าหากคุณต้องการจะใช้กระเป๋านี้ร่วมกับ MyCrypto CX ในอนาคต คุณจำเป็นจะต้องเพิ่มกระเป๋าใหม่อีกครั้งด้วย private key/JSON และรหัสผ่าน ',
...
NODE_Warning                : 'Node ของคุณจะต้องเป็น HTTPS เพื่อที่จะเชื่อมต่อกับ MyCrypto.com คุณสามารถ [ดาวน์โหลดซอร์สโค้ดจาก MyCrypto repo & รันบนเครื่องคอมพิวเตอร์ของคุณ](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest) เพื่อเชื่อมต่อกับ Node ใดๆ หรือสร้างใบรับรอง SSL ผ่าน [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'ชื่อ Node',
...
TranslatorName_1            : '[Tianissimo (Suteepat)](https://mycrypto.com/?gaslimit=21000&to=0x8d0a185C16ADE28bf69Cb38c5e3df605360df40e&value=1.0#send-transaction) ',
