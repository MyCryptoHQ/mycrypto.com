...
tx_Summary                  : 'Ten tijden van hoog transactie volume (zoals tijdens ICOs) kunnen transacties voor uren, zo niet dagen, "pending" blijven. Deze tool heeft als doel om je de mogelijkheid te geven om deze TXs op te sporen en ze te "annuleren" / vervangen. ** Dit is niet typisch iets wat je kunt doen. Je zou er niet op moeten vertrouwen dat dit werkt & het kan alleen werken als de TX Pools vol zitten. [Lees hier meer over deze tool.](https://support.mycrypto.com/transactions/check-status-of-ethereum-transaction.html)**',
...
tx_notFound_2               : 'Als je deze transactie zojuist hebt verzonden, wacht dan eerst 15 seconden en druk nogmaals op de "TX Status" knop. ',
...
tx_notFound_4               : 'Gebruik het drop-down menu in de rechterbovenhoek & selecteer een andere ETH node (bijvoobeeld `ETH (Etherscan.io)` of `ETH (Infura.io)` of `ETH (MyCrypto)`) en check opnieuw.',
...
tx_FoundOnChain_3           : '**Als je geen enkele foutmelding ziet is je transactie met succes verzonden.** Je ETH of Tokens zijn waar je ze naar verzonden hebt. Als je je verzonden ETH of Tokens niet gecrediteerd ziet in je andere wallet / exchange account, en het is inmiddels al 24+ uur geleden sinds je de transactie verzonden hebt, neem dan [contact op met die service](https://support.mycrypto.com/diving-deeper/ethereum-list-of-support-and-communities.html). Geef ze de *link* naar je transactie en vraag ze op je allerliefste manier om naar je situatie te kijken.',
...
GEN_Help_12                 : 'Gebruik het enkel om je wallet te openen via MyCrypto (of Mist, Geth, Parity en andere wallet clients.) ',
...
TXFEE_Desc                  : 'De TX vergoeding (`fee`) wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. De vergoeding is de `gas limiet` * `gas prijs`. [Je kunt hier GWEI -> ETH converteren](https://mycrypto.com/helpers.html)',
...
MYC_Warning_1               : 'Check altijd de URL voordat je jouw wallet opent of een nieuwe wallet genereert. Pas op voor phishing sites! ',

/* Footer */
FOOTER_1                    : 'Een gratis, open source, client-side interface om Ethereum wallets te genereren &amp; meer. Wissel op een gemakkelijke &amp; veilige manier informatie uit met de Ethereum blockchain. Dubbel-check de URL/link ( mycrypto.com ) alvorens je wallet te openen.',
...
ADD_Ledger_0a               : 'Her-open MyCrypto met een veilige (SSL) verbinding ',
ADD_Ledger_0b               : 'Her-open MyCrypto door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0b        : 'Her-open MyCrypto door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Als je deze wallet in de toekomst nog wilt gebruiken met MyCrypto CX, zul je het met de hand moeten toevoegen door gebruik te maken van de prive sleutel/JSON en wachtwoord. ',
...
NODE_Warning                : 'Je node dient HTTPS te zijn om met MyCrypto.com te kunnen verbinden. Je kunt de [MyCrypto repo downloaden](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest) en lokaal uitvoeren en vervolgens met iedere node verbinden. Of, verkrijg een gratis SSL certificaat via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Naam',
...
ERROR_28                    : '**Je hebt je Keystore Bestand & wachtwoord of prive sleutel nodig** om toegang tot deze wallet te verkrijgen in de toekomst. Sla het op & maak een externe back-up! Er is geen enkele manier om je wallet te herstellen als je het nu niet opslaat. Lees ook de help pagina (https://mycrypto.com/#help) voor instructies. ',
...
ERROR_35                    : 'Input adres is niet ge-checksummed. <a href="https://support.mycrypto.com/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> Meer info</a>', // 35
...
PARITY_InvalidGasLimit      : "(parity-05) Hoeveelheid gas is boven de limiet. Supplied gas limit is beyond limit. Try lowering the gas limit to 21000. [Learn More.](https://support.mycrypto.com/gas/what-is-gas-ethereum.html)",
...
TranslatorName_1            : '[h3ll0fr13nd](https://mycrypto.com/?gaslimit=21000&to=0xB5FbCE123F12347206c881cae73A3046BA1A90bA&value=1.0#send-transaction) ',
...
HELP_2b_Title               : '2b) Hoe doe ik veilig / offline / cold storage met MyCrypto? ',
HELP_2b_Desc_1              : 'Ga naar onze github: [https://github.com/MyCryptoHQ/mycrypto.com/releases/latest](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest). ',
...
HELP_3_Desc_3               : 'Navigeer naar de MyCrypto.com "Bekijk Wallet Info" pagina. ',
...
HELP_4CX_Title              : '4) Hoe verzend ik Ether met MyCrypto CX? ',
...
HELP_5_Title                : '5) Hoe voer ik MyCrypto.com offline/lokaal uit? ',
HELP_5_Desc_1               : 'Je kunt MyCrypto.com uitvoeren op je eigen computer in plaats van op de GitHub servers. Je kunt een wallet volledig offline genereren en transacties versturen met behulp van de "Offline Transactie" pagina. ',
HELP_5_Desc_7               : 'MyCrypto.com draait nu volledig op jouw computer. ',
...
HELP_5_Desc_9               : 'Gezien we MyCrypto.com continu updaten, raden we je aan om regelmatig je opgeslagen versie van de repo bij te werken. ',
...
HELP_8_Desc_1               : 'MyCrypto is geen web wallet. Je hoeft niet in te loggen en er zal nooit iets van je op onze servers worden bewaard. Onze website is enkel een interface om toegang te verkrijgen tot de blockchain. ',
HELP_8_Desc_2               : 'Als MyCrypto.com er mee stopt, zul je een andere manier moeten zien te vinden (zoals geth of Ethereum Wallet / Mist) om te doen wat wij doen. Maar wat je niet zult hoeven te doen is je Ether uit MyCrypto halen omdat het niet in MyCrypto zit. Je Ether zit in in welk wallet dan ook je op onze site hebt gegenereerd. ',
...
HELP_8_Desc_4               : 'Daarnaast is de kans dat wij MyCrypto offline halen is miniem tot onmogelijk. Het kost ons vrijwel niets om de site in stand te houden omdat we geen informatie opslaan. Als we toch het domijn offline halen, is het ook altijd nog publiekelijk beschikbaar op [https://github.com/MyCryptoHQ/mycrypto.com](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages). Je kunt daar de ZIP downloaden en het lokaal draaien. ',

HELP_8CX_Title              : '8) Wat gebeurd er als MyCrypto CX verdwijnt? ',
...
HELP_12_Title               : '12) Hoe importeer ik een MyCrypto  wallet in geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Door gebruik te maken van een Geth/Mist JSON bestand van MyCrypto v2+.... ',
...
HELP_14_Title               : '14) Sommige sites zorgen voor een willekeurigheid (seed) bij het genereren van de prive sleutel via muis bewegingen. MyCrypto.com doet dit niet. Is de wikkeleurigheid (random number generation) van MyCrypto wel veilig? ',
...
HELP_SecCX_Title            : 'Beveiliging - MyCrypto CX ',
...
HELP_SecCX_Desc_6           : 'Als we deze items zouden versleutelen, zou je iedere keer dat je je saldo of nicknames wilt checken je wachtwoord moeten invoeren. Als je je hierover zorgen maakt, raden we je aan om gebruik te maken van MyCrypto.com in plaats van deze Chrome Extensie. ',
...
HELP_Sec_Desc_2             : 'We zijn up en running sinds augustus 2015. Als je zoekt naar ["mycrypto" on reddit](https://www.reddit.com/search?q=mycrypto), zul je tal van mensen vinden die ons met groot succes gebruiken. ',
...
HELP_Sec_Desc_4             : 'Controleer de URL -- Deze website draait vanaf GitHub en je kunt de bron code hier vinden: [https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages) naar de domein namen: [https://mycrypto.com](https://mycrypto.com). ',
HELP_Sec_Desc_5             : 'Om wallets te genereren, kun je ook de [source code](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest) downloaden. Zie #5 hierboven. ',
