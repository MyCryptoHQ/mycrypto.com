...
tx_notFound_2               : 'Wenn Sie die Transaktion erst gesendet haben, warten Sie bitte 15 Sekunden und drücken dann den "TX Status" Button erneut. ',
tx_notFound_3               : 'Sie könnte noch in dem Transaktions-Pool eines anderen Node sein und wartet gemined zu werden.',
tx_notFound_4               : 'Bitte benutzen Sie das DropDown Menü oben-rechts & wählen Sie eine andere Node aus (z.B. `ETH (Etherscan.io)` oder `ETH (Infura.io)` oder `ETH (MyCrypto)`) und prüfen es erneut.',
...
GEN_Help_12                 : 'Nutze es um dein Wallet bei MyCrypto (oder Mist, Geth, Parity und andere Wallet Clients.) zu öffnen ',
...
TXFEE_Desc                  : 'Die Transaktionsgebühr wird den Miner(n) bezahlt, die Ihre Transaktion in einen Block einschließen. Es wird durch `Gas-Limit` * `Gas-Preis` berechnet. [Du kannst GWEI -> ETH hier umwandeln](https://mycrypto.com/helpers.html)',
...
/* Header */
MYC_Warning_1               : 'Bitte prüfe stets die URL, bevor du auf dein Wallet zugreifst oder ein neues Wallet erzeugst. Vorsicht vor Phishing-Seiten! ',
...
MYWAL_Content_3             : 'Wenn Sie dieses Wallet in Zukunft mit MyCrypto CX verwenden wollen, müssen Sie es mittels des privaten Schlüssels/JSON Datei und Ihrem Passwort manuell wieder hinzufügen. ',
...
ERROR_28                    : '**Du benötigst deine Keystore-Datei & das Passwort** (oder den privaten Schlüssel) um künftig auf dein Wallet zugreifen zu können. Bitte sichere diese Datei daher auf einem externen Medium! Es gibt KEINE Möglichkeit, ein Wallet wiederherzustellen, wenn du diese Datei und das Passwort nicht sicherst. Lies die [Hilfe-Seite](https://mycrypto.com/#help) für weitere Informationen. ',
...
TranslatorName_2            : '[mawalu](https://mycrypto.com/?gaslimit=21000&to=0xA6e9A24981aFB71f96C7330618139a7B34BCdEc3&value=1.0#send-transaction) · ',
TranslatorAddr_2            : '0xA6e9A24981aFB71f96C7330618139a7B34BCdEc3 ',
/* Translator 2             : Insert Comments Here */
TranslatorName_3            : '[huhn_solo](https://mycrypto.com/?gaslimit=21000&to=0x1DAd1765381460db9A44846cDfA6f74c65A06B77&value=1.0#send-transaction) · ',
TranslatorAddr_3            : '0x1DAd1765381460db9A44846cDfA6f74c65A06B77 ',
/* Translator 3             : Insert Comments Here */
TranslatorName_4            : '[FelixA](https://mycrypto.com/?gaslimit=21000&to=0xb6999051b0Bfad32E192e107181E0ac72bE7EE3D&value=1.0#send-transaction) · ',
TranslatorAddr_4            : '0xb6999051b0Bfad32E192e107181E0ac72bE7EE3D ',
/* Translator 4             : Insert Comments Here */
TranslatorName_5            : 'danielsun174 · ffidan61 · [u/Preisschild](https://mycrypto.com/?gaslimit=21000&to=0x700Eb9142a0CC709fce80709cfbF5Ac25438c584&value=0.1#send-transaction) ',
TranslatorAddr_5            : '',
...
HELP_Desc                   : 'Hast du das Gefühl etwas fehlt? Hast du eine andere Frage? [Schreib uns](mailto:support@mycrypto.com) und wir werden nicht nur deine Frage beantworten, wir werden auch die Seite updaten, damit diese in der Zukunft noch einfacher zu bedienen sein wird! ',
HELP_Remind_Title           : 'Ein paar Erinnerungshilfen ',
HELP_Remind_Desc_1          : '**Ethereum, MyCrypto.com, sowie einige der verwendeten Javascript Bibliotheken, die wir verwenden, befinden sich noch in Entwicklung.** Zwar haben wir alles umfassend getestet und es wurden erfolgeich tausende Wallets von Menschen aus aller Welt kreiert, jedoch bestimmt immer eine gewisse Gefahr, dass etwas unerwartetes passiert und dein Ether verloren geht. Bitte investiere nicht mehr als du verlieren kannst, und sei immer vorsichtig. Sollte etwas schlimmes passieren, **können wir uns leider nicht verantwortlich für einen Verlust zeichnen**. ',
HELP_Remind_Desc_2          : 'MyCrypto.com sind keine "web wallets". Du erstellst keinen Account oder sendest uns Ether den wir halten. Alle Daten bleiben auf deinem Computer, bzw. Browser. Unser Auftrag ist es, dir das Erstellen, Speichern und Zugreifen auf deine Accounts zu vereinfachen, sowie dir eine simple Möglichkeit zur Interaktion mit der Blockchain zu bieten. ',
...
HELP_0_Desc_1               : 'MyCrypto bietet dir die Möglichkeit neue Wallets zu generieren, damit du deinen Ether selbst speichern kannst, und keine Exchange nutzen musst. Dieser Prozess findet ausschließlich auf deinem Computer statt. Daher bist auch **du dafür Verantwortlich, Back-ups zu erstellen** wenn du ein Wallet verwenden möchtest. ',
...
HELP_4CX_Title              : '4) Wie kann ich Ether über MyCrypto CX senden? ',
...
HELP_5_Title                : '5) Wie kann ich MyCrypto.com offline/lokal starten? ',
