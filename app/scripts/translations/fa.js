...
MYC_Tagline: 'MYC_Tagline',
MYC_Warning_1: 'همیشه قبل از استفاده از کیف پول خود و یا ساختن کیف پول جدید آدرس URL را چک کنید. حواستان به سایت های فیشینگ باشد. ',
...
ADD_Ledger_0a: 'با یک کانکشن امن (SSL) دوباره MyCrypto را باز کنید. ',
ADD_Ledger_0b: 'با استفاده از [Chrome](https://www.google.com/chrome/browser/desktop/) یا [Opera](https://www.opera.com/) دوباره MyCrypto را باز کنید. ',
...
MYWAL_Content_3: ',اگر در آینده بخواهید از این کیف پول با استفاده از  MyCrypto CX خود استفاده کنید، باید بصورت دستی دوباره آن را اضافه کنید. این کار با استفاده از key/JASON و رمزعبور انجام می شود.',
...
NODE_Warning: 'نود شما باید HTTPS باشد تا بتوانید از طریق MyCrypto.com به آن متصل شوید. می توانید [مخزن MyCrypto را دانلود و اجرا کنید](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest) تا بتوانید به هر نودی متصل شوید؛ یا می توانید از طریق  [LetsEncrypt](https://letsencrypt.org/) مدرک SSL رایگان دریافت کنید. ',
NODE_Name: 'نام نود ',
NODE_Port: 'پورت نود ',
...
GETH_GasLimit                   :  '(geth-03) سوخت بیش از حد است. Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://support.mycrypto.com/gas/what-is-gas-ethereum.html)',
...
HELP_2b_Desc_1: 'به لینک زیر بروید: https://github.com/MyCryptoHQ/mycrypto.com/releases/latest](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest ',
...
HELP_3_Desc_3: 'به صفحه ""مشاهده اطلاعات کیف پول"" در MyCrypto.com بروید. ',
...
HELP_4CX_Title: 'سوال 4: چگونه با کیف پول MyCrypto خود اتر ارسال کنم؟ ',
...
HELP_5_Title: 'سوال 5: چگونه از MyCrypto.com بصورت آفلاین استفاده کنم؟ ',
HELP_5_Desc_1: 'شما می توانید MyCrypto.com را به جای اجرا از روی سرورهای GitHub، روی کامپیوتر خود اجرا کنید. شما می توانید یک کیف پول را کاملا بصورت آفلاین بسازید و تراکنشی را از طریق صفحه ""تراکنش آفلاین"" ارسال کنید. ',
HELP_5_Desc_7: 'حال MyCrypto.com بطور کامل در حال اجرا شدن از روی کامپیوتر شماست. ',
HELP_5_Desc_8: 'در صورتی که با این موضوع آشنایی ندارید بهتر است بدانید که باید تمام پوشه (فولدر) را نگهداری کنید تا بتوانید وبسایت را اجرا کنید (نه فقط index.html را). به چیزی در این پوشه دست نزنید و یا جابجا نکنید. اگر یک نسخه پشتیبان از کد مخزن MyCrypto را برای آینده نگهداری می کنید پیشنهاد می شود که تنها ZIP را نگهداری کنید تا از اینکه تمام محتوای پوشه درست ذخیره می شوند اطمینان حاصل کنید. ',
HELP_5_Desc_9: 'از آنجایی که ما بطور مداوم در حال بروزرسانی MyCrypto.com هستیم، پیشنهاد می کنیم که نسخه ذخیره شده خود را بصورت دوره ای بروزرسانی کنید. ',
...
HELP_8_Desc_1: 'وبسایت MyCrypto یک کیف پول وبی نیست. نیازی نیست که وارد شوید (لاگین کنید) و هیچ چیزی بر روی سرورهای ما ذخیره نمی شود. این تنها یک ظاهر است که به شما امکان برقراری ارتباط با بلاکچین را می دهد. ',
HELP_8_Desc_2: 'اگر  MyCrypto.com از کار بیافتد، راه دیگری (مثل geth یا Ethereum Wallet/ Mist) وجود دارد که کاری که ما انجام می دهیم را انجام دهد. اما نیازی نیست که اترهای خود را از  MyCrypto بیرون بیاورید چرا که آن ها در  MyCrypto نیستند، بلکه در هر کیف پولی ست که شما از طریق سایت ما ساخته باشید. ',
...
HELP_8_Desc_4: 'علاوه بر این، امکان اینکه  MyCrypto را از کار بیاندازیم نزدیک به صفر است. ازآنجایی که هیچ اطلاعاتی را ذخیره نمی کنیم در نتیجه هیچ هزینه نگهداری هم برای ما ندارد. اگر دامنه را به هر دلیلی از کار بیاندازیم، بصورت عمومی در آدرس های زیر در دسترس خواهد بود. [https://github.com/MyCryptoHQ/mycrypto.com](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages) . می توانید از آنجا ZIP را دانلود کنید و آن را بصورت محلی راه اندازی و اجرا کنید. ',

HELP_8CX_Title: 'سوال 8: اگر  MyCrypto CX ناپدید شود چه اتفاقی میافتد؟ ',
...
HELP_8CX_Desc_2: 'مهم است در نظر داشته باشید که برای هر کیف پولی که با  MyCrypto CX ساخته می شود، از تمام اطلاعات خود یک نسخه پشتیبان تهیه کنید. در اینصورت اگر هر اتفاقی برای  MyCrypto CX یا کامپیوترتان بیافتد، همچنان اطلاعات لازم جهت دسترسی به اترهای خود را خواهید داشت. به سوال 2 الف برای چگونگی تهیه نسخه پشتیبان از کیف پول مراجعه کنید. ',
HELP_8CX_Desc_3: 'اگر به هر دلیلی  MyCrypto CX از Chrome Store ناپدید شد، می توانید سورس (کد منبع) آن را از Github پیدا کرده و بصورت دستی اجرا کنید. به سوال شماره 5 مراجعه کنید. ',
...
HELP_12_Title: 'سوال 12: چگونه کیف پولی که با MyCrypto ساخته ام را به geth یا Ethereum Wallet یا Mist منتقل کنم؟ ',
HELP_12_Desc_1: ',با استفاده از فایل Geth یا Mist JSON از MyCrypto نسخه 2 به بالا.',
...
HELP_14_Title: 'سوال 14: برخی از سایت ها ساخت رندوم یا تصادفی کلیدهای خصوصی را بر اساس حرکت موس انجام می دهند. سایت MyCrypto.com این کار را انجام نمی دهد. آیا تولید تصادفی اعداد برای MyCrypto امن است؟ ',
HELP_14_Desc_1: 'روش ساخت بر اساس حرکت موس هوشمندانه است و می دانیم که  چرا مردم آن را دوست دارند، اما واقعیت این است که window.crypto ؟؟؟؟؟ بیشتری را نسبت به حرکات موس شما ارائه می کنند. حرکات موس ناامن نیستند اما ما (و بسیاری از آزمایش های کریپتو دیگر) در window.crypto باور بیشتری داریم. بعلاوه اینکه از MyCrypto.com می توان در دستگاه های لمسی نیز استفاده کرد. در [اینجا می توانید بحث بین یک نویسنده عصبانی در reddit و Vitalik Buterin درباره حرکات موس و window.crypto را ببینید](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title: 'امنیت - MyCrypto CX ',
...
HELP_SecCX_Desc_6: 'اگر می خواستیم این موارد را رمزنگاری کنیم، هربار که می خواستید موجودی حساب یا نام های اختصاری را ببینید مجبور به وارد کردن رمزعبور می شدید. اگر این موضوع برایتان مهم است، پیشنهاد می کنیم از MyCrypto.com به جای این Chrome Extension استفاده کنید. ',
...
HELP_Sec_Desc_2: 'ما از آگوست 2015 در حال فعالیت هستیم. اگر در [reddit](https://www.reddit.com/search?q=MyCrypto) بدنبال MyCrypto بگردید، تعداد زیادی از کاربران را خواهید دید که از سرویس ما با موفقیت استفاده کرده اند.  ',
...
HELP_Sec_Desc_4: 'این سایت از طریق GitHub ارائه می شود، می توانید کد اصلی یا Source Code آن را در این آدرس ببینید:  [https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages) و [https://mycrypto.com](https://mycrypto.com). ',
HELP_Sec_Desc_5: 'برای ایجاد کیف پول، می توانید کد منبع را دانلود کنید و آن را بصورت محلی اجرا کنید. به سوال شماره 5 مراجعه کنید. (https://github.com/MyCryptoHQ/mycrypto.com/releases/latest) ',
