...
tx_notFound_4               : 'Utilizza il menu a discesa in alto a destra e scegli un altro nodo ETH (ad esempio `ETH (Etherscan.io)` o `ETH (Infura.io)` o `ETH (MyCrypto)`) e ricontrolla.',
...
tx_FoundOnChain_3           : '**Se non vedi errori, la transazione è stata inviata correttamente.** I tuoi ETH o i tuoi token sono dove li hai inviati. Se non vedi questi ETH o token nell\'altro portafoglio / nel conto della piattaforma di scambio, e se sono passate più di 24 ore dall\'invio, [contatta quel servizio esterno](https://support.mycrypto.com/diving-deeper/ethereum-list-of-support-and-communities.html). Invia loro il *link* alla transazione e chiedi, cortesemente, di controllare la tua situazione.',
...
GEN_Help_12                 : 'Usalo per sbloccare il portafoglio tramite MyCrypto (o Mist, Geth, Parity e altri client.) ',
...
TXFEE_Desc                  : 'La commissione transazione si paga ai *miner* perché includano la transazione in un blocco. Si calcola come `limite gas` * `prezzo gas`. [Puoi calcolare la conversione GWEI -> ETH qui](https://mycrypto.com/helpers.html)',
...
/* Header */
MYC_Warning_1               : 'Controlla sempre l\'URL prima di accedere al tuo portafoglio o di crearne uno nuovo. Fai attenzione ai siti di phishing! ',
...
MYC_Tagline                 : 'Portafoglio ether JavaScript lato client Open Source ',
CX_Tagline                  : 'Portafoglio ether JavaScript lato client Open Source (Estensione Chrome) ',

/* Footer */
FOOTER_1                    : 'Interfaccia gratuita, open source, lato client per generare portafogli Ethereum e altro. Interagisci con la *blockchain* Ethereum facilmente e in modo sicuro. Controlla bene l\'URL ( mycrypto.com ) prima di sbloccare un portafoglio.',
FOOTER_1b                   : 'Creato da ',
...
sidebar_donation            : 'MyCrypto è un servizio gratuito e open-source votato alla tua privacy e sicurezza. Più donazioni riceviamo, più tempo dedichiamo a creare nuove funzionalità, considerare i tuoi commenti, e darti ciò che vuoi. Siamo solo due persone che provano a cambiare il mondo. Ci aiuti? ',
sidebar_donate              : 'Dona ',
...
MYWAL_Content_3             : 'Se vorrai utilizzare questo portafoglio con MyCrypto CX in futuro, dovrai ri-aggiungerlo manualmente tramite la chiave privata/JSON e password. ',
...
ADD_Ledger_0a               : 'Devi accedere a MyCrypto tramite una connessione sicura (SSL / HTTPS) per poterti collegare. ',
ADD_Ledger_0b               : 'Riapri MyCrypto utilizzando [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
NODE_Warning                : 'Il tuo nodo deve utilizzare HTTPS per potertici collegare da MyCrypto.com. Puoi [scaricare il repository di MyCrypto ed eseguirlo in locale](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest) per collegarti ad altri tipi di nodo. Oppure, ottieni un certificato SSL gratuito tramite [LetsEncrypt](https://letsencrypt.org/)',
...
ERROR_35                    : 'L\'indirizzo inserito non ha un checksum. <a href="https://support.mycrypto.com/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> Ulteriori informazioni</a>', // 35
...
TranslatorName_1            : '[ugilio](https://mycrypto.com/?gaslimit=21000&to=0x07932bc1c68c8ff188f4225e892178ab6d8c4eaa&value=1.0#send-transaction) ',
...
HELP_Desc                   : 'Vedi che manca qualcosa? Hai un\'altra domanda? [Mettiti in contatto con noi](mailto:support@mycrypto.com), e non solo risponderemo alla tua domanda, ma aggiorneremo anche questa pagina in modo che sia più utile ad altri in futuro! ',
HELP_Remind_Title           : 'Qualche promemoria ',
HELP_Remind_Desc_1          : '**Ethereum, MyCrypto.com, e alcune delle librerie Javascript che utilizziamo sono in continuo sviluppo.** Anche se abbiamo testato approfonditamente e persone di tutto il mondo hanno correttamente creato decine di migliaia di portafogli, c\'è sempre la remota possibilità che accada qualcosa di imprevisto che provochi la perdita dei tuoi ETH. Ti preghiamo di non investire più di quello che sei disposto a perdere, e di fare attenzione. Se dovesse capitare qualcosa, ci dispiace, ma **non siamo responsabili per gli ether perduti**. ',
HELP_Remind_Desc_2          : 'MyCrypto.com non sono "portafogli web". Non stai creando un account né ci stai dando i tuoi ether da custodire. Tutti i dati non lasciano mai il tuo computer/il tuo browser. Quello che facciamo è renderti facile creare, salvare, e accedere alle tue informazioni e interagire con la *blockchain*. ',
...
HELP_2b_Title               : '2b) Come implemento un portafoglio offline in maniera sicura con MyCrypto? ',
HELP_2b_Desc_1              : 'Vai su [https://github.com/MyCryptoHQ/mycrypto.com/releases/latest](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest). ',
...
HELP_3_Desc_3               : 'Vai alla pagina "Informazioni portafoglio" su MyCrypto.com. ',
...
HELP_4CX_Title              : '4) Come invio degli ether utilizzando MyCrypto CX? ',
...
HELP_5_Title                : '5) Come faccio ad eseguire MyCrypto.com offline/in locale? ',
HELP_5_Desc_1               : 'Puoi eseguire MyCrypto.com sul tuo computer invece che dai server di GitHub. Puoi generare un portafoglio completamente offline e inviare transazioni dalla pagina "Invia Offline". ',
HELP_5_Desc_7               : 'MyCrypto.com è ora in esecuzione completamente sul tuo computer. ',
...
HELP_5_Desc_9               : 'Dal momento che stiamo costantemente aggiornando MyCrypto.com, ti consigliamo di aggiornare periodicamente la tua versione locale del repository. ',
...
HELP_8_Desc_1               : 'MyCrypto non è un portafoglio web. Non hai un login e niente viene mai salvato nei nostri server. È semplicemente un\'interfaccia che ti consente di interagire con la *blockchain*. ',
HELP_8_Desc_2               : 'Se MyCrypto.com va giù, dovrai trovare un altro modo (come geth o Ethereum Wallet / Mist) per fare quello che facciamo noi. Ma non dovrai "tirare fuori" i tuoi ether da MyCrypto perché non si trovano in MyCrypto. Sono in qualunque portafoglio tu abbia generato tramite il nostro sito. ',
...
HELP_8_Desc_4               : 'Inoltre, la probabilità che tiriamo giù MyCrypto è prossima allo zero. Non ci costa praticamente nulla mantenerlo dal momento che non stiamo memorizzando alcuna informazione. Se anche disattivassimo il dominio, è ancora, e sarà sempre, disponibile pubblicamente su [https://github.com/MyCryptoHQ/mycrypto.com](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages). Puoi scaricare lo ZIP da lì ed eseguirlo in locale. ',

HELP_8CX_Title              : '8) Che succede se MyCrypto CX sparisce? ',
...
HELP_8CX_Desc_2             : 'Detto ciò, è **molto importante** che tu faccia un backup di tutte le informazioni relative a ogni nuovo portafoglio generato con MyCrypto CX. In questo modo se succede qualcosa a MyCrypto CX or al tuo computer avrai ancora tutte le informazioni necessarie ad accedere ai tuoi ether. Vedi la domanda n. 2a per come salvare i tuoi portafogli. ',
HELP_8CX_Desc_3             : 'Se per qualche ragione MyCrypto CX sparisce dal Chrome Store, puoi trovare i sorgenti su Github e caricare l\'estensione manualmente. Vedi la domanda n. 5 qui sopra. ',
...
HELP_12_Title               : '12) Come faccio a importare un portafoglio creato con MyCrypto in geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Con un file JSON Geth/Mist generato da MyCrypto v2+.... ',
...
HELP_14_Title               : '14) Certi siti inizializzano il generatore di numeri casuali per la generazione della chiave privata tramite i movimenti del mouse. MyCrypto.com non lo fa. La generazione di numeri casuali di MyCrypto è sicura? ',
HELP_14_Desc_1              : 'Sebbene usare i movimenti del mouse sia ingegnoso, e comprendiamo perché piaccia, la realtà è che window.crypto assicura maggiore entropia rispetto ai tuoi movimenti del mouse. Non che i movimenti del mouse siano insicuri, è solo che noi (e un sacco di altri critto-esperimenti) crediamo in window.crypto. Oltretutto, MyCrypto.com può essere utilizzato su dispositivi touch. Qui c\'è una [conversazione fra un utente di reddit arrabbiato e Vitalik Buterin su movimenti del mouse contro window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) e qui c\'è [la specifica del w3 di window.crypto](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Sicurezza - MyCrypto CX ',
...
HELP_SecCX_Desc_6           : 'Se crittografassimo questi elementi dovresti inserire una password ogni volta in cui volessi vedere il saldo del tuo conto o i nomi dei portafogli. Se ciò ti preoccupa, ti consigliamo di usare MyCrypto.com invece di questa estensione di Chrome. ',
...
HELP_Sec_Desc_2             : 'Siamo attivi da agosto 2015. Se cerchi ["mycrypto" su reddit](https://www.reddit.com/search?q=mycrypto), puoi vedere che molte persone ci utilizzano con grande successo. ',
...
HELP_Sec_Desc_4             : 'Controlla l\'URL -- Questo sito viene servito attraverso GitHub e puoi vederne il codice sorgente qui: [https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages) su [https://mycrypto.com](https://mycrypto.com). ',
HELP_Sec_Desc_5             : 'Per la generazione dei portafogli, puoi scaricare il [codice sorgente](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest) ed eseguirlo in locale. Vedi la domanda 5 qui sopra. ',
