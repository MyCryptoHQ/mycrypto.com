...
X_HelpfulLinks_4                :  'MyCryptoから、またはそれに向けて移管中', /*Migrating to/from MyCrypto*/
...
/* Onboarding */
ONBOARD_welcome_title           :  'いらっしゃいませ！ MyCrypto.com へようこそ！', /*Welcome to MyCrypto.com*/
...
ONBOARD_secure_3_content__6     :  '[さらに安全確保のためのセキュリティ情報！](https://support.mycrypto.com/getting-started/protecting-yourself-and-your-funds.html)', /*[Even more Security Tips!](https://support.mycrypto.com/getting-started/protecting-yourself-and-your-funds.html)*/
...
ERROR_28                    : '(error_29) お財布を操作するためには**Keystore/JSONとパスワードか秘密鍵が必要** 保存してから、外部バックアップしてください！ここで保存しないとお財布が使用できなくなります。詳細はヘルプページを参照してください。(https://mycrypto.com/#help) (You need this `Keystore File + Password` or the `Private Key` (next page) to access this wallet in the future. ) ',
...
ERROR_35                    : '(error_36) チェックサムが付いていません。 <a href="https://support.mycrypto.com/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> 詳細</a (Input address is not checksummed. <a href="https://support.mycrypto.com/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer">What does that mean?</a>)>',
...
GETH_GasLimit               : '(geth-03) ブロックガスリミットを越えています Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://support.mycrypto.com/gas/what-is-gas-ethereum.html)',
...
GETH_Nonce                  : '(geth-08) Nonce が足りません This TX\'s [nonce](https://support.mycrypto.com/transactions/what-is-nonce.html) is too low. Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://support.mycrypto.com/transactions/check-status-of-ethereum-transaction.html).',
...
PARITY_InsufficientGasPrice : "(parity-04) トランザクションフィー不足です。 ノードの最小 fee を満たしていません。 (minimal: {}, got: {}). fee を増やしてください。 There is another transaction with same nonce in the queue, or the transaction fee is too low. Try incrementing the nonce by clicking the Generate button again. [Learn More.](https://support.mycrypto.com/transactions/transactions-not-showing-or-pending.html)",
PARITY_InvalidGasLimit      : "(parity-05) ガス供給量が制限を超過しています。 Supplied gas limit is beyond limit. Try lowering the gas limit to 21000. [Learn More.](https://support.mycrypto.com/gas/what-is-gas-ethereum.html)",
...
GEN_Help_12                 : 'MyCryptoの上でこれを使って自分のお財布をアンロックしてください（Mist, Geth, Parityや他のお財布クライアントも可）', /*Use it to unlock your wallet via MyCrypto (or Mist, Geth, Parity and other wallet clients.)*/
...
MYC_Warning_1               : 'お財布を操作したり新しいお財布を作成する前に、必ずURLを確認してください。詐欺サイトに御注意ください！ ',
MYC_Tagline                 : 'オープンソース JavaScript クライアントサイド Etherお財布 ',
...
NODE_Warning                : 'MyCrypto.com 経由で接続するためには、HTTPSノードが必要です。[MyCryptoをレポジトリからダウンロードして、手元で走らせ、](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest)いずれかのノードに接続することもできます。 あるいは、無料のSSL証明書を[LetsEncrypt](https://letsencrypt.org/)から入手してください',
NODE_Name                   : 'ノード名',
NODE_Port                   : 'ノードポート',
