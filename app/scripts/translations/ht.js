...
tx_FoundOnChain_3           : '**Si vous ne voyez pas d\'erreur, votre transaction a été envoyée avec succès.** Vos ETH ou Tokens sont à l\'endroit où vous les avez envoyés. Si vous ne voyez pas ces ETH ou Tokens dans votre autre portefeuille ou compte de place d\'échange, et si cela fait plus de 24 heures, veuillez [contacter ce service](https://support.mycrypto.com/diving-deeper/ethereum-list-of-support-and-communities.html). Envoyez-leur le *lien* vers votre transaction et demandez, poliment, d\'examiner votre situation.',
...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec MyCrypto (ou Mist, Geth, Parity et autres wallet clients.) ',
...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `gas limit` * le `gas price`. [Vous pouvez convertir GWEI -> ETH ici](https://mycrypto.com/helpers.html)',
...
MYC_Tagline                 : 'BOUS d\'Ether Open Source JavaScript POU KLIYAN AN ',
MYC_Warning_1               : 'TOUJOU BYEN VERIFYE L’URL ANVAN W’ ANTRE NAN BOUS OU A OSWA POU KREYE YON LÒT BOUS. ATANSYON AK FO SIT YO ',
...
sidebar_donation            : 'MyCrypto  SE YON SÈVIS GRATIS EPI YON OPEN SOURCE KI RESPEKTE VI SEKRÈ W’ AK SEKIRITE W’. PLIS N’AP JWENN ANPIL DON, PLIS N’AP PASE ANPIL TAN POU N’ DEVLOPE LÒT FONKSYON YO, N’AP TANDE SA W’ MANDE  AK BA W’ SA W’ BEZWEN . NOU SE KÈK MOUN K’AP ESEYE CHANJE MOND LA. EDE NOU! ',
...
MYWAL_Content_3             : 'SI W’ VLE SÈVI AK BOUS SA  AVÈK MyCrypto CX NAN LÒT JOU YO, OU DWE METE L’ ANKÒ  SÈVI AK KLE SEKRÈ A /PAJ JSON AK KÒD SEKRÈ A ',
...
NODE_Warning                : 'NE W’ LA DWE AN HTTPS POU W’ KONEKTE AVÈK MyCrypto.com. OU KAPAB [PRAN REPO MYWALLET LA EPI OUVRI  L’ LOKALMAN ](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest) POU W’ KONEKTE A KÈK LÒT NE , OSWA POU W’ GENYEN SÈTIFIKA SSL GRATIS AVÈK[LetsEncrypt](https://letsencrypt.org/).',
NODE_Name                   : 'NON NE A ',
NODE_Port                   : 'PÒ NE A ',
...
ERROR_28                    : '**OU BEZWEN PAJ KEYSTORE W’ LA EPI KÒD SEKRÈ A ** ( OSWA KLE SEKRÈ W’ LA) POU KAPAB ANTRE NAN BOUS SA NAN LÒT JOU YO. TANPRI PRAN L’EPI  POU W’ SERE L’ YON KOTE DEYÒ ! PA GEN OKENN LÒT MWAYEN POU W’ JWENN ANKÒ YON BOUS SI W’ PA ANREJISTRE L’. TANPRI LI PAJ SA [PAJ POU EDE](https://mycrypto.com/#help) POU DETAY YO ',
...
ERROR_35                    : 'Input address is not checksummed. <a href="https://support.mycrypto.com/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank"  rel="noopener noreferrer"> More info</a>', // 35
...
TranslatorName_1            : '[Nogo10](https://mycrypto.com/?gaslimit=21000&to= 0x152e77CC3Dd8d86471ebEa8e93B9924A41e7055a&value=1.0#VOYE-TRANSFÈ A) · ',
...
HELP_Desc                   : 'MANKE YON BAGAY ? SI W’ GEN LÒT KESYON ? [PALE AK NOU]( mailto:support@mycrypto.com), N’AP REPONN OU EPI N’AP TOU METE PAJ LA A JOU POU L’ KA ITIL PI PLIS AK TOUT LÒT MOUN YO NAN LÒT JOU YO ! ',
HELP_Remind_Title           : 'KÈK NAN SA POU SONJE YO: ',
HELP_Remind_Desc_1          : 'ETHEREUM, MyCrypto.com & MYETHER WALLET CX, EPI KÈK NAN BIBLIYOTÈK YO  JAVASCRIPT KI ANBA KE NOU KONN SÈVI AK YO KÒMANSE AP DEVLOPE.** NOU PASE YO GWO TÈS EPI ANPIL DIZÈNN AK MILYE BOUS SA YO TE KREYE AVÈK ANPIL SIKSÈ TOUT KOTE NAN MOND LA. KA TOUJOU GEN YON TI KRAS POSIBLITE KE YON BAGAY KA PASE KI KA PÈMÈT OU PÈDI ETH OU YO. PA ENVESTI PLIS PLIS KE SA W ‘ KA PRÈ POU W’ PÈDI EPI PRIDANS. NAN KA AKSIDAN, N’AP DEZOLE MEN ** NOU P’AP RESPONSAB POU ETHER  SA W’ PÈDI A** ',
HELP_Remind_Desc_2          : 'MyCrypto.com YO PA "BOUS WEB". OU PA KREYE YON KONT , OU PA BA NOU ETHER W’ YO TANKOU DEPO. OKENN DONE PA SÒTI NAN KOMPITÈ W’ OSWA NAVIGATÈ W’ LA. N’AP FASILITE W’ POU W KREYASYON AN. KIJAN POU KENBE  L’ EPI ANTRE NAN ENFÒMASYON W’ YO AK KONTAK OU MENM AK BLOCKCHAIN NAN. ',
...
HELP_0_Desc_1               : 'MYCRYPTO BA W’ MWAYEN POU W’ KREYE PLIZYÈ LÒT BOUS POU W’ KACHE ETHER OU A OU MENM EPI SE PA SOU YON ** CHANJ** PWOSESIS SA KA FÈT SOU YON KOMPITÈ, SE PA SOU SÈVÈ NOU YO. LÈ W’AP KREYE YON LÒT BOUS ** SE RESPONSABLITE W’ POU W’ BYEN KENBE L’ AN SEKIRITE** ',
...
HELP_2b_Title               : '2b) KÒMAN POU M’ JERE AK TOUT SEKIRITE YON MAGAZEN SAN SIYAL AVÈK MYCRYPTO? ',
HELP_2b_Desc_1              : 'ALE NAN GITHUB NOU AN : [https://github.com/MyCryptoHQ/mycrypto.com/releases/latest](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest). ',
...
HELP_3_Desc_3               : 'NAVIGE AL NAN PAJ  " FÈ PARÈT YON BOUS"  MyCrypto.com LA. ',
...
HELP_4CX_Title              : '4) KÒMAN POU M’ KA VOYE RTHER AVÈK MYCRYPTO CX ? ',
...
HELP_5_Title                : '5) KÒMAN M KA OUVRI MyCrypto.com SAN SIYAL/LOKAL ? ',
HELP_5_Desc_1               : 'OU KAPAB OUVRI MyCrypto.com SOU KOMPITÈ W’ LA SAN W’ PA PASE NAN SÈVÈ GITHUB YO. OU KAPAB KREYE YON BOUS SAN OU PA BEZWEN GEN SIYAL EPI VOYE TRANSFÈ YO SÒTI NAN PAJ SA "TRANSFÈ SAN SIYAL". ',
HELP_5_Desc_7               : 'TOUT MyCrypto.com LA VIRE SOU KOMPITÈ W’ LA KOUNYE A. ',
HELP_5_Desc_8               : 'NAN KA OU PA TA ABITYE  AK SA. OU DWE KONSÈVE TOUT DOSYE A POU W’ VIRE SIT WEB LA EPI  PA SÈLMAN INDEX.HTML. PA MANYEN ANYEN, PA DEPLASE ANYEN NAN DOSYE A. SI W’ KENBE YON REPO NAN MAGAZEN MYCRYPTO POU LÒT JOU YO, NOU MANDE W’ PA METE ZIP LA SÈLMAN NAN MAGAZENN AN POU W’ KA ASIRE W’ KE DOSYE A PA GEN TACH. ',
HELP_5_Desc_9               : 'NOU TOUJOU AP AMELYORE MyCrypto.com, NOU MANDE W’ POU W’ TOUJOU METE A JOU VÈSYON W’ TE KENBE A. ',
...
HELP_8_Desc_1               : 'MYCRYPTO SE PA YON BOUS SOU WÈB LA. OU PA GEN KONEKSYON EPI ANYEN PA JANM ANREJISTRE SOU SÈVÈ NOU YO. SE JIS YON LÒT FAS KI PÈMET OU PALE AK BLOCKCHAIN LA. ',
HELP_8_Desc_2               : 'SI MyCrypto.com TONBE, OU DWE JWENN YON LÒT MWAYEN ( TANKOU GETH OSWA ETHEREUM WALLET / MIST) POU FÈ MENM BAGAY LA. MEN OU PA GEN POU "REPRAN " ETHER W’ LA KI NAN MY ETHERWALLET PASKE L’ PA NAN MY ETHERWALLET. LI LAKAY OU. NAN BOUS SA W’ TE KREYE SOU SIT NOU AN. ',
...
HELP_8_Desc_4               : 'ANPLIS, FASON POU N’ TA KITE MYCRYPTO TONBE LI PRE ZEWO.SA KOUTE NOU PRESKE ANYEN POU N’ KENBE L’ TANKOU JAN NOU PA KENBE OKENN ENFÒMASYON. SI DOMÈNN SA TA VIN PÈDI. LOJISYÈL LA AP TOUJOU DISPONIB POU PIBLIK LA SOU [https://github.com/MyCryptoHQ/mycrypto.com](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages). OU KAPAB PRAN ZIP LA  EPI SÈVI AK LI LOKAL. ',

HELP_8CX_Title              : '8) SA KI AP PASE SI MYCRYPTO CX DISPARÈT ? ',
...
HELP_8CX_Desc_2             : 'SA VLE DI, LI **ENPÒTAN ANPIL**  POU W’ TA KENBE TOUT DONE POU TOUT BOUS OU KREYE YO AK MYCRYPTO CX. NAN FASON SA NENPÒT  SA KI TA RIVE MYCRYPTO CX OSWA KOMPITÈ W’ LA, W’AP TOUJOU KONSÈVE TOUT ENFÒMASYON NESESÈ YO POU W’ KAANTRE NAN ETHER W’ YO. GADE #2 A POU W’ KENBE BOUS OU YO. ',
HELP_8CX_Desc_3             : 'SI, POU NENPÒT REZON, MYCRYPTO CX TA DISPARÈT NAN CHROME STORE A, OU KAPAB JWENN SOUS LA SOU GTITHUB EPI PRAN L’.  GADE #5 KI ANLÈ A. ',
...
HELP_12_Title               : '12) KÒMAN POU M’ PRAN YON BOUS KI KREYE AK MYCRYPTO NAN GETH/ ETHEREUM WALLET/ MIST ? ',
HELP_12_Desc_1              : 'AVÈK YON PAJ GETH/MIST JSON NAN MYCRYPTO V2+…. ',
...
HELP_14_Title               : '14) KÈK SIT PA AZA ( KONN REKÒMANSE) KREYASYON KLE SEKRÈ A NAN MOUVMAN ANTRE SÒTI YO. KA SA PA POU MyCrypto.com. KANTITE KREYASYON ALE VINI POU MyCrypto.com ESKE L’ KONFYAN? ',
HELP_14_Desc_1              : 'MENM KE KANPE MOUVMAN SOURI A ANPIL MOUN JIJE LI GEN ATIRANS , EPI NOU TA KA KONPRANN REZON YO, REYALITE A SE WINDOW.CRYPTO A MEZIRE LIMIT DEZÒD ZIZTÈM PLIS KE MOUVMAN SOURI W’ LA. JAN W’ SÈVI AK MOUVMAN SA YO YO BON MEN NOU(ANSANM AK PLIZYÈ PWOJÈ KRYPTO YO) GEN ANPIL BON REZON POU N’ KWÈ NAN WINDOW.CRYPTO A. ANPLIS, MyCrypto.com KAPAB SÈVI SOU EKRAN OU KAPAB TOUCHE YO. MEN YON [KONVÈSASYON KI FÈT AK REDDITOR RAGEUR EPI VITALIK BUTERIN SOU MOUVMAN SOURI YO EPI WINDOW.CRYPTO] (https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) EPI MEN  [SPESYAL W3 YO  WINDOW.CRYPTO AN](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'KLE – MYCRYPTO CX ',
...
HELP_SecCX_Desc_6           : 'SI NOU TA DWE METE KÒD NAN ENFÒMASYON YO, FÒK OU TA ANTRE YON KÒD SEKRÈ NAN CHAK MOMAN OU BEZWEN WÈ LAJAN SOU KONT OU OSWA LÒT TI NON YO. SI SA NWI W’,NOU MANDE W’ POU SÈVI AK MyCrypto.com KE EXTENSION CHROME SA. ',
...
HELP_Sec_Desc_2             : 'NOU TE KÒMANSE NAN MWA DAWOU 2015. SI W’ AL CHÈCHE ["mycrypto" SOU reddit](https://www.reddit.com/search?q=mycrypto), OU KAPAB WÈ YON PAKÈT BANN MOUN K’AP SÈVI AK NOU SAN OKENN PWOBLÈM. ',
...
HELP_Sec_Desc_4             : 'VERIFYE URL LA – SIT SA SÈVI AK GITHUB EPI OU KAPAB WÈ KÒD SOUS LA LA : : [https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages) NAN  [https://mycrypto.com](https://mycrypto.com). ',
HELP_Sec_Desc_5             : 'POU W’ KREYE BOUS YO, OU KAPAB PRAN [KÒD SOUS LA] (https://github.com/MyCryptoHQ/mycrypto.com/releases/latest). GADE #5 KI ANLÈ A.  ',
