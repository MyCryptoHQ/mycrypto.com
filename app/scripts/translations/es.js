...
tx_notFound_4               : 'Por favor usa el desplegable en la parte superior derecha y selecciona un nodo ETH diferente (ej. `ETH (Etherscan.io)` o `ETH (Infura.io)` o `ETH (MyCrypto)`) y comprueba de nuevo.',
...
/* Header */
MYC_Warning_1               : 'Comprueba siempre la URL antes de acceder a tu cartera o crear una cartera nueva. ¡Ten cuidado con los sitios falsos (phishing)! ',
...
MYC_Tagline                 : 'Cartera Ether JavaScript de código abierto ejecutado en el cliente ',
...
MYWAL_Content_3             : 'Si en el futuro quieres utilizar esta cartera con MyCrypto CX, tendrás que volver a añadirla manualmente utilizando Clave Privada/JSON y contraseña. ',
...
NODE_Warning                : 'Tu nodo debe ser HTTPS para poder conectar a él desde MyCrypto.com. Para conectarte a cualquier nodo, puedes [descargar el repositorio de MyCrypto y ejecutarlo localmente](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest). También puedes conseguir un certificado SSL gratuito a través de [Let\'s Encrypt](https://letsencrypt.org/)',
...
ADD_Ledger_0a               : 'Volver a abrir MyCrypto en una conexión segura (SSL) ',
ADD_Ledger_0b               : 'Volver a abrir MyCrypto usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
HELP_2b_Title               : '2b) ¿Cómo almaceno con seguridad/sin conexión/en frío con MyCrypto? ',
HELP_2b_Desc_1              : 'Ve a nuestro github: [https://github.com/MyCryptoHQ/mycrypto.com/releases/latest](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest). ',
...
HELP_3_Desc_3               : 'Ve a la página "Ver Información de las Carteras" de MyCrypto.com. ',
...
HELP_4CX_Title              : '4) ¿Cómo envío ether utilizando MyCrypto CX? ',
...
HELP_5_Title                : '5) ¿Cómo ejecuto MyCrypto.com sin conexión/localmente? ',
HELP_5_Desc_1               : 'Puedes ejecutar MyCrypto.com en tu equipo en lugar de desde los servidores de GitHub. Puedes generar una cartera totalmente sin conexión y enviar transacciones desde la página "Transacción sin conexión". ',
...
HELP_5_Desc_9               : 'Debido a que estamos constantemente actualizando MyCrypto.com, recomendamos que actualices periódicamente tu versión guardada del repositorio. ',
...
HELP_8_Desc_1               : 'MyCrypto no es una cartera web. No tienes un login y nunca se graba nada en nuestros servidores. You don\'t have a login and nothing ever gets saved to our servers. Simplemente es una interfaz que te permite interactuar con la cadena de bloques. ',
HELP_8_Desc_2               : 'Si MyCrypto.com desapareciera, tendrías que encontrar otra manera de poder hacer lo que haces con nosotros (como por ejemplo obtener geth o Ethereum Wallet / Mist). Pero no necesitarías retirar tus ether de MyCrypto porque no están en MyCrypto. Están en la cartera que hayas generado a través de nuestro sitio. ',
...
HELP_8_Desc_4               : 'Además, la probabilidad de que cerremos MyCrypto es casi nula. No nos cuesta prácticamente nada mantenerlo ya que no almacenamos ninguna información. Si borramos el dominio, continúa estando disponible y siempre lo estará en [https://github.com/MyCryptoHQ/mycrypto.com](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages). Puedes descargar desde ahí el archivo ZIP y ejecutarlo localmente. ',

HELP_8CX_Title              : '8) ¿Qué ocurre si MyCrypto CX desaparece? ',
...
HELP_8CX_Desc_2             : 'Dicho esto, es **muy importante** que respaldes toda tu información para todas las nuevas carteras generadas con MyCrypto CX. De este modo, si algo le ocurre a MyCrypto CX o a tu equipo, seguirás teniendo toda la información necesaria para poder acceder a tus ether. Ver la pregunta #2a sobre cómo respaldar tus carteras. ',
HELP_8CX_Desc_3             : 'Si por algún motivo MyCrypto CX desaparece de Chrome Store, puedes encontrar el código fuente en Github y cargarlo manualmente. Ver #5 más arriba. ',
...
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experments) believe in window.crypto. In addition, MyCrypto.com can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Seguridad - MyCrypto CX ',
...
HELP_SecCX_Desc_6           : 'Si cifráramos estos ítems, sería necesario que introduzcas una contraseña cada vez que quisieras comprobar el saldo de tu cuenta o vizualizar los alias. Si esto te preocupa, te recomendamos que utilices MyCrypto.com en lugar de esta extensión de Chrome. ',
...
HELP_Sec_Desc_2             : 'Hemos estado funcionando desde agosto de 2015. Si buscas ["MyCrypto" en reddit](https://www.reddit.com/search?q=MyCrypto), puedes encontrar numerosas personas que nos utilizan con gran éxito. ',
...
HELP_Sec_Desc_4             : 'Comprueba la URL -- Este sitio se sirve a través de GitHub y puedes ver el código fuente aquí: [https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages) a [https://mycrypto.com](https://mycrypto.com). ',
HELP_Sec_Desc_5             : 'Para generar carteras, puedes descargar el [código fuente](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest). Ver #5 más arriba. ',
