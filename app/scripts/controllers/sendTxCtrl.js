    ...
    $scope.sendTx = function() {
        ...
        uiFuncs.sendTx($scope.signedTx, function(resp) {
            if (!resp.isError) {
                ...
                var verifyTxBtn = $scope.ajaxReq.type != nodes.nodeTypes.Custom ? '<a class="btn btn-xs btn-info" href="' + txHashLink + '" class="strong" target="_blank" rel="noopener noreferrer">Verify Transaction (Etherscan)</a>' : '';
                var verifyTxEtherchainBtn = $scope.ajaxReq.type == 'ETH' ? '<a class="btn btn-xs btn-info" href="' + txHashLinkEtherchain + '" class="strong" target="_blank" rel="noopener noreferrer">Verify Transaction (Etherchain)</a>' : '';
                var checkTxBtn = '<a class="btn btn-xs btn-info" href="' + checkTxLink + '" target="_blank" rel="noopener noreferrer"> TX Status </a>';
